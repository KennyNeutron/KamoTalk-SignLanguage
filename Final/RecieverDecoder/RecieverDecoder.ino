...
void Correspond() {
  ...
  if (gesture('A', 90, 70, 80, 250, 110, 250, 110, 140, 255, 240) >= 33 ) {
    signing();
  } else  if (gesture('B', 80, 50, 80, 150, 250, 440, 230, 300 , 255, 251) >= 33) {
    signing();
  } else  if (gesture('C', 70, 350, 100, 250, 140, 300, 120, 180, 255, 240) >= 33) {
    signing();
  }   else  if (gesture('D', 60, 350, 100, 150, 230, 260, 115, 160, 241, 242 ) >= 33) {
    signing();
  }   else  if (gesture('E', 80, 30, 80, 165, 112, 230, 100, 150, 240, 240 ) >= 33) {
    signing();
  }   else  if (gesture('F', 80, 350, 90, 145, 100, 450, 210, 300, 254, 255 ) >= 33) {
    signing();
  } else  if (gesture('G', 150, 260, 180, 160, 115, 220, 100, 140, 240, 240 ) >= 33) {
    signing();
  } else  if (gesture('H', 150, 250, 170, 170, 230, 430, 125, 150, 255, 253 ) >= 33) {
    signing();
  } else  if (gesture('I', 90, 100, 75, 140, 100, 220, 105, 300, 248, 248 ) >= 33) {
    signing();
  } else  if (gesture('J', 130, 250, 160, 140, 100, 220, 105, 300, 248, 248 ) >= 33) {
    signing();
  } else  if (gesture('K', 90, 270, 150, 170, 225, 340, 120, 140, 241, 242 ) >= 33) {
    signing();
  } else   if (gesture('L', 50, 10, 80, 250, 180, 250, 110, 140, 255, 255) >= 33 ) {
    signing();
  }  else   if (gesture('M', 330, 15, 290, 170, 110, 270, 110, 150, 240, 240) >= 33 ) {
    signing();
  }  else   if (gesture('N', 355, 350, 215, 165, 110, 295, 120, 160, 240, 240) >= 33 ) {
    signing();
  } else  if (gesture('O', 70, 350, 100, 250, 140, 300, 120, 180, 240, 240) >= 33) {
    signing();
  }    else  if (gesture('&', 160, 190, 110, 140, 110, 255, 105, 160, 240, 240) >= 33) {
    signing();
  }  else  if (gesture('@', 160, 205, 135, 140, 210, 245, 110, 225, 249, 250 ) >= 33) {
    signing();
  } else if (gesture('S', 350, 10, 300, 250, 110, 250, 110, 140, 255, 241) >= 33 ) {
    signing();
  }    else {
    NowSigning = ' ';
    SignPrinted = false;
