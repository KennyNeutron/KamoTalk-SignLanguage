...
void Correspond() {
  ...
  if (gesture('A', 90, 70, 80, 250, 110, 250, 110, 140, 255, 240) >= 33 && IndexByte == 240) {
    signing();
  } else  if (gesture('B', 80, 50, 80, 150, 250, 440, 230, 300 , 255, 255) >= 33  && IndexByte == 255) {
    signing();
  } else  if (gesture('C', 70, 350, 100, 250, 140, 300, 120, 180, 255, 240) >= 33 && IndexByte == 240) {
    signing();
  }   else  if (gesture('D', 60, 350, 100, 150, 230, 260, 115, 160, 240, 242 ) >= 23 && IndexByte == 255) {
    signing();
  }   else  if (gesture('E', 80, 30, 80, 165, 112, 230, 100, 150, 240, 240 ) >= 33 && IndexByte == 240) {
    signing();
  }   else  if (gesture('F', 70, 350, 90, 145, 100, 450, 150, 300, 254, 255 ) >= 33) {
    signing();
  } else  if (gesture('G', 150, 260, 180, 160, 115, 220, 100, 140, 240, 240 ) >= 33) {
    signing();
  } else  if (gesture('H', 70, 270, 170, 170, 230, 430, 125, 150, 243, 253 ) >= 23 && IndexByte == 253) {
    signing();
  } else  if (gesture('I', 90, 100, 75, 140, 100, 220, 105, 300, 248, 248 ) >= 33) {
    signing();
  } else  if (gesture('J', 130, 250, 160, 140, 100, 220, 105, 300, 248, 248 ) >= 33) {
    signing();
  } else  if (gesture('K', 90, 270, 150, 170, 225, 340, 120, 140, 253, 254 ) >= 33) {
    signing();
    ...
    signing();
  }  else  if (gesture('P', 350, 350, 250, 230, 290, 450, 130, 240, 255, 253) >= 33) {
    signing();
  }   else  if (gesture('Q', 350, 350, 250, 155, 130, 215, 100, 135, 255, 240) >= 33 && IndexByte == 255 ) {
    signing();
  }   else  if (gesture('R', 85, 55, 80, 130, 280, 390, 110, 140, 255, 253) >= 33) {
    signing();
  }  else  if (gesture('&', 160, 190, 110, 140, 110, 255, 105, 160, 240, 240) >= 33) {
    signing();
  }  else  if (gesture('@', 160, 205, 135, 140, 210, 245, 110, 225, 249, 250 ) >= 33) {
    signing();
  } else if (gesture('S', 350, 10, 300, 250, 110, 250, 110, 140, 255, 241) >= 33 && IndexByte == 241  ) {
    signing();
  }    else {
    NowSigning = ' ';
    SignPrinted = false;
